...
export default function AdminBlogCmsPage() {
  ...
  const [articles, setArticles] = React.useState([
    {
      id: "a1",
      title: "Top 10 Self Drive Routes in Maharashtra",
    ...
    {
      id: "a2",
      title: "Safety Tips for Long Road Trips in Monsoon",
      category: "Safety",
      status: "DRAFT",
      date: "2026-06-29",
    },
          ...
          <tbody className="divide-y divide-border text-foreground/80">
            {articles.map((art) => (
              <tr key={art.id} className="hover:bg-muted/10">
                <td className="flex items-center gap-2 p-4 font-semibold text-foreground">
