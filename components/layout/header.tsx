        ...
        <div className="mx-auto flex h-14 sm:h-16 max-w-7xl items-center justify-between px-2.5 sm:px-6 lg:px-8">
          ...
          <div className="hidden items-center gap-4 xl:gap-5 lg:flex">
            ...
            <a
              ...
              className="inline-flex h-9 items-center gap-2 rounded-xl border border-emerald-500/30 bg-emerald-500/10 dark:bg-emerald-950/40 px-3.5 text-[13px] font-semibold text-emerald-600 dark:text-emerald-400 transition-colors hover:bg-emerald-500/20 hover:border-emerald-500/50 shadow-2xs shrink-0"
            >
              <svg
            ...
            >
              {theme === "dark" ? <Sun className="h-4.5 w-4.5 stroke-[1.8]" /> : <Moon className="h-4.5 w-4.5 stroke-[1.8]" />}
            </button>
