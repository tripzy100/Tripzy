    ...
    >
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
        ...
        <nav className="hidden items-center gap-8 lg:flex">
          ...
          >
            Explore Fleet <ChevronDown className="h-4 w-4" />
          </button>
          <Link
            href="/cities"
        ...
        <div className="hidden items-center gap-4 lg:flex">
          <a
            ...
            className="group flex items-center gap-1.5 text-xs font-semibold text-muted-foreground transition-colors hover:text-[#25D366]"
            aria-label="Chat on WhatsApp"
          >
            <svg
              className="h-4 w-4 fill-muted-foreground transition-colors group-hover:fill-[#25D366]"
              viewBox="0 0 24 24"
          ...
          <a
            ...
            className="mr-1 text-xs font-semibold text-muted-foreground transition-colors hover:text-foreground"
          >
            +91 92342 73063
          </a>
          <button
