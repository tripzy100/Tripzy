...
const envSchema = z.object({
  ...
  SMS_PROVIDER: z.enum(["none", "console"]).default("none"),
...
try {
  ...
  if (process.env.NODE_ENV === "production") {
    ...
    env = {
      ...
      NEXT_PUBLIC_SUPABASE_URL: process.env.NEXT_PUBLIC_SUPABASE_URL || (() => {
        console.error("[Config] NEXT_PUBLIC_SUPABASE_URL is not set!");
        throw new Error("NEXT_PUBLIC_SUPABASE_URL is required. Set it to your Supabase project URL (e.g., https://your-project-ref.supabase.co).");
      })(),
      ...
      RESEND_FROM_EMAIL: process.env.RESEND_FROM_EMAIL || "Tripzy <notifications@tripzytours.in>",
      SMS_PROVIDER: (process.env.SMS_PROVIDER as "none" | "console") || "none",
